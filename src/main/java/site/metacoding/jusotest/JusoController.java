...
public class JusoController {
    ...
    public String home(Model model) {
        String jusoUrl = "https://www.juso.go.kr/addrlink/addrLinkUrl.do?confmKey=devU01TX0FVVEgyMDIyMDUyMzIyMTY0NjExMjYwMzg=&returnUrl=http://localhost:8080/juso/callback&resultType=4";
